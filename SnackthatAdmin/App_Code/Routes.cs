...
public class Routes
{
    ...
    /// <summary>
    /// Method to obtain the last Routes of the table
    /// </summary>
    /// <returns>Returns the last 5 rows of the table</returns>
    public DataTable getLastRoutes()
    {
        return aR.callProcedure("getLastRoutes");
    }
}