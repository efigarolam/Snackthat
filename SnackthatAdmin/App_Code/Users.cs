...
/// <summary>
/// This class deals with the Users of the application, allows you to do the CRUD operations.
/// </summary>
public class Users
{
    ...
    /// <summary>
    /// Method to obtain the last Users on the database
    /// </summary>
    /// <returns>Returns a DataTable with the last 5 rows of the table</returns>
    public DataTable getLastUsers()
    {
        return aR.callProcedure("getLastUsers");
    }
}