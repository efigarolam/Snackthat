...
/// <summary>
/// This class deals with the database and the stored procedures.
/// </summary>
public class ActiveRecord
{
    ...
    public ActiveRecord()
	{
        MySqlConnection connection = new MySqlConnection("server = localhost; user id = root; database = snackthat; Allow Zero Datetime=false;Convert Zero Datetime=True");
